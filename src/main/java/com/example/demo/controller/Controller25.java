...
public class Controller25 {
	...
	// @RequestMapping(value = "lunk3",method = RequestMethod.POST)
	@PostMapping("link3")
	public void method3() {
		System.out.println("/sub25/lunk3 POST에서 메소드 일함");
	}
	...
	public void method4(@PathVariable String p1) {
	...
	@GetMapping("ink5/id/{var1}/name/{var2}")
	...
	@GetMapping("link12")
	public String method12(RedirectAttributes rt) {
		rt.addFlashAttribute("list",List.of("강백호","서태웅"));
	...
	//	rttr.addFlashAttribute(null,rttr); //목적지의 model Attribute로
	...
	public String method15(RedirectAttributes rttr) {
		...
		rttr.addAttribute("email","adb@naver.com");
		rttr.addAttribute("location","seoul");
		return "redurect:link16";
	}
