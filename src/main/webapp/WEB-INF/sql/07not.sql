...
SELECT * FROM Customers WHERE NOT Country = 'Germany'; -- 11
...
-- 50년대 생이 아닌 직원들 조회
SELECT * FROM Employees WHERE BirthDate >= '1950-01-01' AND BirthDate <= '1950-12-31';
SELECT * FROM Employees
WHERE NOT (BirthDate >= '1950-01-01' AND BirthDate <= '1950-12-31');
SELECT * FROM Emplotees
